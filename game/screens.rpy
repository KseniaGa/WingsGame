...
screen about():
    ...
    use game_menu(_("Про гру"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("\n\nНАША КОМАНДА:\n\n🇺🇦 Оля Тменова - Гейм дизайн, Графіка\n🇺🇦 Саша Тменова - Гейм дизайн, Сюжет\n🇺🇦 Ксюша Гаршіна - Гейм дизайн, Сюжет\n🇦🇹🇵🇱 Том Тучек - Програмування\n🇺🇦 Іра Білик - Музика\n🇺🇦 Міша Менделенко - Музика\n🇨🇿 Міро Брезік - Гейм дизайн")
