...
label resist: 
    ...
    a "Who should we start with?"
    a "Wait, why don't I just choose for you? Let's see..."
...
label vila_hope: 
    ...
    # Epic music? 
    # The screen get darker and darker and the only thing we can see is the "menu" choices: Hope, Accept Help, Keep Going, Fight, Persevere
